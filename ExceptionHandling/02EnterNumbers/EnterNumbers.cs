...
class EnterNumbers
{
    static int ReadNumber(int start, int end, int previousNum)
    {
        int num = 0;
        try
        {
    ...
    static void Main(string[] args)
    {
        const int START = 1;
        const int END = 1000;
        Console.WriteLine("Enter 10 numbers on separate lines ,each next number should be bigger than previous in range [1 - 1000]:");
        int num = 0;
        int previousNum = 0;
        for (int i = 0; i < 10; i++)
        {
